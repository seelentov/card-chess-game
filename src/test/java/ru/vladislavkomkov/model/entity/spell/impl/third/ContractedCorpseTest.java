...
public class ContractedCorpseTest extends SpellTestCase
{
  @Test
  void testDefault()
  {
    super.testDefault(new ContractedCorpse());
  }
  
  @Test
  void testOnPlayed()
  {
      player.addToHand(Card.of(new ContractedCorpse(player)));
      player.playCard(0);
      ...
      assertTrue(((Unit)player.getHand().get(0).getEntity()).isAnswerOnDead());
  }
}
